                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Discover your next open-source project</span>
                                    ...
                                    <h1
                                        className="mt-8   text-bold font-bold font-mono max-w-4xl mx-auto text-balance text-3xl md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link href="/language/python">
                                                <span className="text-nowrap">Start Contributing</span>
                                            </Link>
                                        </Button>
                                    </div>
                                    <Button
                    ...
                    <div className="group relative m-auto max-w-5xl px-6">
                        <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
                            <Link
                                ...
                                <span> Projects from Top Ecosystems</span>
